...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    const localTehme = localStorage.getItem("theme");
    document
      .querySelector("html")
      .setAttribute("data-theme", localTehme, "class", { color: "black" });
  }, [theme]);
  ...
  return (
    <div className="sticky top-0 z-[99]">
      <div className="navbar bg-[#212121] text-white mt-4">
        ...
        <div className="flex-none">
          ...
          <ul
            ...
            <li>
              <label className="swap swap-rotate ml-3 mt-3">
